...
public:
    ...
    void setupUi(QWidget *ThreeD_Reconstruction)
    {
        if (ThreeD_Reconstruction->objectName().isEmpty())
            ThreeD_Reconstruction->setObjectName(QString::fromUtf8("ThreeD_Reconstruction"));
        ...
        qvtkWidget_3DRec->setObjectName(QString::fromUtf8("qvtkWidget_3DRec"));
    ...
    {
        ThreeD_Reconstruction->setWindowTitle(QCoreApplication::translate("ThreeD_Reconstruction", "\344\270\211\347\273\264\351\207\215\345\273\272", nullptr));
    } // retranslateUi
