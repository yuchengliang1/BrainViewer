	...
	: QMainWindow(parent)
{
	...
	icon_Play.addFile(QStringLiteral(":/BrainViewer/Resources/play_128px_1197036_easyicon.net.ico"), QSize(), QIcon::Normal, QIcon::Off);
	icon_Pause.addFile(QStringLiteral(":/BrainViewer/Resources/pause_128px_1197034_easyicon.net.ico"), QSize(), QIcon::Normal, QIcon::Off);
	PlayFlag = false;
...
//播放器定时触发
void BrainViewer::OnPlayerTimerOut()
{
...
void BrainViewer::OnChangeAppState()
{
	switch (AppState)
	{
	case Idel:		  //空闲状态
...
void BrainViewer::OnChangeCursorValue()
{
...
void BrainViewer::OnChangeWindowsWL()
{
...
//打开Series文件夹
void BrainViewer::OnOpenSeriesFolder()
{
	//获取Series文件夹的绝对路径名
...
//打开单张Dicom文件
void BrainViewer::OnOpenDicomFile()
{
	//打开文件选择页面
...
//打开DICOMDIR文件
void BrainViewer::OnOpenDicomDirFile()
{							  
	//打开文件选择页面
...
//添加测距尺
void BrainViewer::addDistanceWidget()
{
...
//添加量角器
void BrainViewer::addAngleWidget()
{
...
//添加轮廓工具
void BrainViewer::addContourWidget()
{
...
//添加切片页码
void BrainViewer::SetSliceText(int current,int max)
{
...
//添加Dicom文件头信息
void BrainViewer::SetUsageText(std::string imagefilename)
{
...
//添加坐标轴指示
void BrainViewer::addOrientationMarker()
{
...
//添加二维尺度标尺
void BrainViewer::addBiDimensionalWidget()
{
...
//创建树视图上下文菜单
void BrainViewer::CreateContextMenu()
{
...
void BrainViewer::ShowImageByIndex(int Index)
{
...
//修改当前光标类型
void BrainViewer::setCursor(CURSOR newValue)
{
	CursorType = newValue;
...
//修改窗宽窗位模式
void BrainViewer::setWindowWL(WINDOWWL newWL)
{
	ImageWindow = newWL;
	//选项互斥
	ui.action_WindowWL_All->setChecked(false);
...
// 改变程序的状态
void BrainViewer::setAppState(STATE new_state)
{
	AppState = new_state;
 ...
 */
void BrainViewer::RenderInitializer(std::string folder,int NumOfImage )
{
	/*
	 * reader初始化
	 */
 ...
 */
void BrainViewer::RenderRefresh(std::string imagefilename,int currentPagenumber,int maxPageNumber)
{
	//切换文件
...
//刷新DIR树
void BrainViewer::DirTreeRefresh(DicomPatient * patient)
{
	QStringList headers;
...
//回到第一张
void BrainViewer::OnResetToFirst()
{
	ui.SliceScrollBar->setSliderPosition(0);
}

//选中默认鼠标指针工具
void BrainViewer::OnSelectedPointer()
{
...
//选中量角器工具
void BrainViewer::OnSelectedProtractor()
{
	setCursor(CURSOR::PROTRACTOR);
}

//选中测距尺工具
void BrainViewer::OnSelectedRuler()
{
	setCursor(CURSOR::RULER);
}

//选中轮廓工具
void BrainViewer::OnSelectedContour()
{
	setCursor(CURSOR::CONTOUR);
}

//选中二维标尺工具
void BrainViewer::OnSelectedBiDimensional()
{
	setCursor(CURSOR::BIDI);
}

//选中灰阶工具
void BrainViewer::OnSelectedGrayLevel()
{
...
//选中缩放工具
void BrainViewer::OnSelectedZoom()
{
 ...
 //选中移动工具
void BrainViewer::OnSelectedMove()
{
...
//属性docking窗口的开关
 void BrainViewer::OnSwitchProperty()
 {
...
//树视图上下文菜单分发
 void BrainViewer::on_treeView_customContextMenuRequested(QPoint pos)
 {
...
//树视图右键菜单->显示当前病人的所有信息
 void BrainViewer::OnShowDicomCurrentTags()
 {
	 QMessageBox::information(this, QStringLiteral("嘿嘿!"), QStringLiteral("这个人很懒,什么都没留下!"));
 }

//显示选中的Series
 void BrainViewer::OnShowSelectedSeries()
 {
...
//显示当前选中的Image
 void BrainViewer::OnShowSelectedImage()
 {
	 /*
...
//Slice滚动条值更改事件
 void BrainViewer::OnSliceScrollBarValueChange(int a)
 {
	 current = a;
	 ShowImageByIndex(a);
 }
...
//响应三维重建命令
void BrainViewer::On3D_Reconstruction()
{
	/*
...
//响应图像分割操作
void BrainViewer::OnSegmentImage()
{
	/*
	 * 先显示这张image
	 */
...
//响应DicomDir类传送过来的信号,其中包含了一个病人的ID
 void BrainViewer::receiveData(QString data)
 {
 ...
 //下一个病人
 void BrainViewer::OnLatterPatient()
 {
 ...
 //上一个病人
 void BrainViewer::OnPreviousPatient()
 {
	 if (CurrentPatient == NULL)
		 return;
	 //1.从数据库类接口上换下一个病人
 ...
 //默认窗宽窗位
 void BrainViewer::OnWindowWL_Defaut()
 {
...
//全部动态范围
 void BrainViewer::OnWindowWL_All()
 {
...
//腹部
 void BrainViewer::OnWindowWL_CT_Abdomen()
 {
 ...
 //血管
 void BrainViewer::OnWindowWL_CT_BloodVessel()
 {
	 m_pImageViewer->SetColorLevel(300.0);
 ...
 //骨骼
 void BrainViewer::OnWindowWL_CT_Bones()
 {
	 m_pImageViewer->SetColorLevel(300.0);
	 m_pImageViewer->SetColorWindow(1500.0);
	 m_pImageViewer->Render();
...
//脑
 void BrainViewer::OnWindowWL_CT_Brain()
 {
	 m_pImageViewer->SetColorLevel(40.0);
 ...
 //纵膈
 void BrainViewer::OnWindowWL_CT_Medias()
 {
	 m_pImageViewer->SetColorLevel(40.0);
	 m_pImageViewer->SetColorWindow(400.0);
	 m_pImageViewer->Render();
 ...
 //肺
 void BrainViewer::OnWindowWL_CT_Lungs()
 {
 ...
 //启动配准工具
 void BrainViewer::OnRegistration()
 {
...
//测试入口2
 void BrainViewer::OnTestEntrance_02()
 {
	//现在测试的是计时器
	 m_pTimer->start();
 }